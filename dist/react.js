...
// src/react.ts
var reactions = /* @__PURE__ */ new Set([
  "THUMBS_UP",
  "THUMBS_DOWN",
  "LAUGH",
  "HOORAY",
...
var reactionContent = (value, fallback = "") => {
...
var main = async () => {
  ...
  if (removeContent) {
    try {
      ...
      warning(
        `Could not remove ${removeContent} reaction: ${error2 instanceof Error ? error2.message : String(error2)}`
      );
    }
  }
  if (addContent) {
    try {
      ...
      warning(
        `Could not add ${addContent} reaction: ${error2 instanceof Error ? error2.message : String(error2)}`
      );
    }
  }
};
