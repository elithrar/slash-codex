...
var main = async () => {
  ...
  const server = createServer(async (request, response) => {
    try {
      ...
      response.end(
        JSON.stringify({ error: error2 instanceof Error ? error2.message : String(error2) })
      );
    }
  });
